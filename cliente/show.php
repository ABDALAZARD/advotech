...
<h3>Processos do(a) Sr./Sra <?php echo $_SESSION["nome"] ?></h3>
...
<br><br>
            ...
            <div class="row" >
                ...
                <?php   
                       ...
                       }else{ echo "Não encontramos nenhum processo vinculado ao seu CPF     :'( <br>Mas não se preocupe, entre em contato com o seu advogado e pergunte o que aconteceu."; }
                ?>  
                  </ul>
